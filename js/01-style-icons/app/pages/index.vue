...
<template>
  <NuxtLayout name="dashboard">
    <template #header-title>
      <ProseH1 class="mb-0 max-lg:ps-3">
        Page title1
      </ProseH1>
    </template>
    ...
    <div class="flex flex-row flex-nowrap items-center justify-between gap-1">
      ...
      <div class="w-2/4 flex flex-row justify-center gap-4">
        <button
          ...
          @click="makeSave"
        >
          <BtnClockIcon v-if="processStatus.save" class="w-lg h-lg" />
        ...
        <button
          ...
          @click="makeApply"
        >
          <BtnClockIcon v-if="processStatus.apply && !processStatus.save" class="w-lg h-lg" />
