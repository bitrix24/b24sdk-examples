...
<template>
					...
					<template v-for="(subItem, subItemIndex) in item.items" :key="subItemIndex">
						...
						>
							<B24Avatar
								...
								:b24ui="{
									root: subItem?.isInstall ? 'bg-green-150' : 'bg-blue-150',
									icon: subItem?.isInstall ? 'text-green-400' : 'text-blue-400'
								}"
							/>
	...
	<footer class="fixed bottom-0 z-1 w-full bg-white shadow-top-md p-2">
