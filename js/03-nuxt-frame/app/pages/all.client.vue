...
import { LoggerBrowser, Result, B24LangList, useB24Helper, LoadDataType, useFormatter } from '@bitrix24/b24jssdk'
import type { IResult, SelectedUser, TypePullMessage, StatusClose, B24Frame } from '@bitrix24/b24jssdk'
...
definePageMeta({
  title: 'Testing Bitrix24 Testing Frame'
})
...
<template>
  <div class="mx-lg my-sm flex flex-col">
		<div
     :class="{ 'overflow-hidden': !isInit || isReload }"
		>
			<div
