		...
		<div class="px-4 py-4 bg-white rounded-md">
			...
			<table class="text-left table-auto w-full">
				<thead>
					<tr class="border-b border-gray-200">
						<th class="py-2 px-1 w-2">
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="size-5 text-base-500 dark:text-base-200">
						...
						<th class="py-2 px-4 w-[250px] text-sm/6 font-semibold text-base-900">Parameter</th>
						<th class="py-2 px-4 text-sm/6 font-semibold text-base-900">Value</th>
					</tr>
				</thead>
				<tbody>
				<tr>
					<td class="py-2 px-1 border-b border-gray-200 text-sm/6">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
						     class="size-5 text-base-500 dark:text-base-200">
							<path fill="currentColor" fill-rule="evenodd" d="M4 5h17v2H4zm0 6h17v2H4zm17 6H4v2h17z"
							      clip-rule="evenodd"/>
						</svg>
					</td>
					<td class="py-2 px-4 border-b border-gray-200 text-sm/6 text-base-900">Name</td>
					<td class="py-2 px-4 border-b border-gray-200 text-sm/6 text-base-900"><?=$result?->NAME?></td>
				...
				<tr>
					...
					<td class="py-2 px-4 border-b border-gray-200 text-sm/6 text-base-900">Last Name</td>
					<td class="py-2 px-4 border-b border-gray-200 text-sm/6 text-base-900"><?=$result?->LAST_NAME?></td>
				</tr>
				<tr>
					<td class="py-2 px-1 text-sm/6">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
						     class="size-5 text-base-500 dark:text-base-200">
							<path fill="currentColor" fill-rule="evenodd" d="M4 5h17v2H4zm0 6h17v2H4zm17 6H4v2h17z"
							      clip-rule="evenodd"/>
					...
					<td class="py-2 px-4 text-sm/6 ">Is Admin</td>
					<td class="py-2 px-4 text-sm/6 <?=$result?->ADMIN
						? 'text-green-500'
						: 'text-red-500';?>"><?=$result?->ADMIN
							? 'True'
							: 'False';?></td>
				</tr>
				</tbody>
