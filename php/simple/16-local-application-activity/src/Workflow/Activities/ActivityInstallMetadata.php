...
final readonly class ActivityInstallMetadata
{
    public function __construct(
        ...
        /**
         * Объект с параметрами активити. Содержит объекты, каждый из которых описывает параметр активити.
        ...
        /**
         * Объект с дополнительными результатами активити. Содержит объекты, каждый из которых описывает параметр активити.
         * Параметр управляет возможностью активити ожидать ответа приложения и работать с данными, которые придут в ответе.
         * Системное название параметра должно начинаться с буквы и может содержать символы a-z, A-Z, 0-9 и нижнее подчеркивание _
         * @var array
         */
        ...
        /**
         * Объект с правилами ограничения активити по типу документа и редакции.
         *
         * Может содержать ключи:
         *
         * INCLUDE — массив правил, где активити будет отображен
         * EXCLUDE — массив правил, где активити будет скрыт
