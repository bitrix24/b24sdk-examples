...
======
Пользовательские поля для сущностей 
...
2. Как выглядит жизненный цикл для пользовательских полей?

2.1 Установка приложения
2.2 Установка доп.данных приложения (в т.ч. пользовательские поля)
2.3 CRUD операции с сущностями для которых были добавлены пользовательские поля
2.4 Удаление приложения
(а что с данными?)
